import pandas as pd
from sklearn.linear_model import LinearRegression #Mo hinh hoi quy tuyen tinh
...
#Huấn luyện mô hình hồi quy tuyến tính (Train)
reg = LinearRegression() #tao mo hinh hoi quy tuyen tinh
